...
Webflow.define('maps', module.exports = function ($, _) {
  ...
  var googleMapsApiKey = 'AIzaSyDjWzhgvQK370eatgmbDGtZGn5TwWmjGCw';
...
Webflow.require('ix').init([
  {"slug":"slide-out-opening-wrapper","name":"Slide Out Opening Wrapper","value":{"style":{"x":"250px","y":"0px","z":"0px"},"triggers":[]}},
  {"slug":"slide-in-out-opening-wrapper-on-click","name":"Slide in-out Opening Wrapper on Click","value":{"style":{},"triggers":[{"type":"click","selector":".opening-hours-wrapper","preserve3d":true,"stepsA":[{"transition":"transform 200 ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"transition":"transform 200 ease 0","x":"250px","y":"0px","z":"0px"}]}]}},
  {"slug":"hide-popup-on-initial","name":"Hide Popup on Initial","value":{"style":{"display":"none","opacity":0,"scaleX":1.09,"scaleY":1.09,"scaleZ":1},"triggers":[]}},
  {"slug":"close-contact-popup-on-click","name":"Close Contact Popup on Click","value":{"style":{},"triggers":[{"type":"click","selector":".contact-wrapper","preserve3d":true,"stepsA":[{"opacity":0,"transition":"transform 200 ease 0, opacity 200 ease 0","scaleX":1.09,"scaleY":1.09,"scaleZ":1},{"display":"none"}],"stepsB":[]}]}},
  {"slug":"show-contact-wrapper-on-click","name":"Show Contact Wrapper on Click","value":{"style":{},"triggers":[{"type":"click","selector":".contact-wrapper","preserve3d":true,"stepsA":[{"display":"block","opacity":1,"transition":"transform 200 ease 0, opacity 200 ease 0","scaleX":1,"scaleY":1,"scaleZ":1}],"stepsB":[]}]}},
  {"slug":"silde-out-lightbox-overlay-on-load","name":"Silde Out Lightbox Overlay on Load","value":{"style":{"opacity":0},"triggers":[]}},
  {"slug":"slide-out-zoom-icon-on-load","name":"Slide Out Zoom Icon on Load","value":{"style":{"opacity":0,"x":"0px","y":"20px","z":"0px"},"triggers":[]}},
  {"slug":"slide-in-gallery-content-on-hover","name":"Slide In Gallery Content on Hover","value":{"style":{},"triggers":[{"type":"hover","selector":".lightbox-overlay","descend":true,"stepsA":[{"opacity":1,"transition":"opacity 400ms ease 0"}],"stepsB":[{"opacity":0,"transition":"opacity 400ms ease 0"}]},{"type":"hover","selector":".zoom-icon","descend":true,"preserve3d":true,"stepsA":[{"opacity":1,"transition":"transform 400ms ease 0, opacity 400ms ease 0","x":"0px","y":"0px","z":"0px"}],"stepsB":[{"opacity":0,"transition":"transform 400ms ease 0, opacity 400ms ease 0","x":"0px","y":"30px","z":"0px"}]}]}},
  {"slug":"display-none-on-load","name":"Display None on Load","value":{"style":{"display":"none"},"triggers":[]}},
  {"slug":"show-navigation-scroll-on-scroll","name":"Show Navigation Scroll on Scroll","value":{"style":{},"triggers":[{"type":"scroll","selector":".scroll-navigation","preserve3d":true,"stepsA":[{"transition":"transform 200 ease 0","x":"0px","y":"-100%","z":"0px"},{"display":"none"}],"stepsB":[{"display":"block","transition":"transform 200 ease 0","x":"0px","y":"0px","z":"0px"}]}]}}
]);
